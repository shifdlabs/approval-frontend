...
export const staticPrimaryColor = '#314f91'
export const staticPrimaryDarkenColor = '#263d7d'
export const staticPrimaryDarkColor = '#6d8fe2'
export const staticPrimaryDarkenDarkColor = '#5a7dce'
