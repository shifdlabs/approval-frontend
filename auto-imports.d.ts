...
declare global {
  ...
  const $refreshTokenApi: typeof import('./src/composables/useApi')['$refreshTokenApi']
  const AttachmentFolderName: typeof import('./src/utils/s3')['AttachmentFolderName']
  ...
  const S3BucketUrl: typeof import('./src/utils/s3')['S3BucketUrl']
  const SignatureFolderName: typeof import('./src/utils/s3')['SignatureFolderName']
  const acceptHMRUpdate: typeof import('pinia')['acceptHMRUpdate']
  const allowedFileType: typeof import('./src/utils/attachment.manager')['allowedFileType']
  ...
  const basicDateConverter: typeof import('./src/utils/converter')['basicDateConverter']
  ...
  const convertToFileRequest: typeof import('./src/utils/attachment.manager')['convertToFileRequest']
  ...
  const deleteFile: typeof import('./src/utils/attachment.manager')['deleteFile']
  const deleteS3File: typeof import('./src/utils/s3')['deleteS3File']
  const documentLetterHeadType: typeof import('./src/utils/static.value')['documentLetterHeadType']
  const documentPriorityType: typeof import('./src/utils/static.value')['documentPriorityType']
  const documentPublicationNumberTypes: typeof import('./src/utils/static.value')['documentPublicationNumberTypes']
  const documentTabs: typeof import('./src/utils/static.value')['documentTabs']
  const documentType: typeof import('./src/utils/static.value')['documentType']
  const eagerComputed: typeof import('@vueuse/core')['eagerComputed']
  const effectScope: typeof import('vue')['effectScope']
  const emailValidator: typeof import('./src/@core/utils/validators')['emailValidator']
  const extendRef: typeof import('@vueuse/core')['extendRef']
  const fileIcon: typeof import('./src/utils/icon.mapped')['fileIcon']
  ...
  const formatFileSize: typeof import('./src/utils/attachment.manager')['formatFileSize']
  const formatToWeekdayTime: typeof import('./src/utils/converter')['formatToWeekdayTime']
  const getActivePinia: typeof import('pinia')['getActivePinia']
  const getCurrentInstance: typeof import('vue')['getCurrentInstance']
  const getCurrentScope: typeof import('vue')['getCurrentScope']
  const getExtension: typeof import('./src/utils/icon.mapped')['getExtension']
  const h: typeof import('vue')['h']
  const handleClick: typeof import('./src/utils/attachment.manager')['handleClick']
  const handleDrop: typeof import('./src/utils/attachment.manager')['handleDrop']
  const handleFileChange: typeof import('./src/utils/attachment.manager')['handleFileChange']
  const handleFileClick: typeof import('./src/utils/attachment.manager')['handleFileClick']
  const handleFileDrop: typeof import('./src/utils/attachment.manager')['handleFileDrop']
  const handleRemoveFile: typeof import('./src/utils/attachment.manager')['handleRemoveFile']
  ...
  const letterHeadType: typeof import('./src/utils/static.value')['letterHeadType']
  const logicAnd: typeof import('@vueuse/math')['logicAnd']
  const logicNot: typeof import('@vueuse/math')['logicNot']
  const logicOr: typeof import('@vueuse/math')['logicOr']
  const makeDestructurable: typeof import('@vueuse/core')['makeDestructurable']
  const mapActions: typeof import('pinia')['mapActions']
  const mapBookingNumber: typeof import('./src/utils/model.mapper')['mapBookingNumber']
  const mapDocument: typeof import('./src/utils/model.mapper')['mapDocument']
  const mapDocumentReference: typeof import('./src/utils/model.mapper')['mapDocumentReference']
  const mapGetters: typeof import('pinia')['mapGetters']
  const mapGroupedWithFormat: typeof import('./src/utils/model.mapper')['mapGroupedWithFormat']
  const mapPosition: typeof import('./src/utils/model.mapper')['mapPosition']
  const mapState: typeof import('pinia')['mapState']
  const mapStores: typeof import('pinia')['mapStores']
  const mapToAttachments: typeof import('./src/utils/model.mapper')['mapToAttachments']
  const mapUser: typeof import('./src/utils/model.mapper')['mapUser']
  const mapWritableState: typeof import('pinia')['mapWritableState']
  const markRaw: typeof import('vue')['markRaw']
  const maxLengthValidator: typeof import('./src/@core/utils/validators')['maxLengthValidator']
  ...
  const onFileChange: typeof import('./src/utils/attachment.manager')['onFileChange']
  ...
  const radioContent: typeof import('./src/utils/static.value')['radioContent']
  ...
  const removeFile: typeof import('./src/utils/attachment.manager')['removeFile']
  ...
  const uploadAllFiles: typeof import('./src/utils/attachment.manager')['uploadAllFiles']
  const uploadFile: typeof import('./src/utils/s3')['uploadFile']
  const uploadS3File: typeof import('./src/utils/s3')['uploadS3File']
...
declare module 'vue' {
  ...
  interface ComponentCustomProperties {
    ...
    readonly $refreshTokenApi: UnwrapRef<typeof import('./src/composables/useApi')['$refreshTokenApi']>
    readonly AttachmentFolderName: UnwrapRef<typeof import('./src/utils/s3')['AttachmentFolderName']>
    readonly COOKIE_MAX_AGE_1_YEAR: UnwrapRef<typeof import('./src/utils/constants')['COOKIE_MAX_AGE_1_YEAR']>
    readonly EffectScope: UnwrapRef<typeof import('vue')['EffectScope']>
    readonly S3BucketUrl: UnwrapRef<typeof import('./src/utils/s3')['S3BucketUrl']>
    readonly SignatureFolderName: UnwrapRef<typeof import('./src/utils/s3')['SignatureFolderName']>
    readonly acceptHMRUpdate: UnwrapRef<typeof import('pinia')['acceptHMRUpdate']>
    readonly allowedFileType: UnwrapRef<typeof import('./src/utils/attachment.manager')['allowedFileType']>
    ...
    readonly basicDateConverter: UnwrapRef<typeof import('./src/utils/converter')['basicDateConverter']>
    ...
    readonly convertToFileRequest: UnwrapRef<typeof import('./src/utils/attachment.manager')['convertToFileRequest']>
    ...
    readonly deleteFile: UnwrapRef<typeof import('./src/utils/attachment.manager')['deleteFile']>
    readonly deleteS3File: UnwrapRef<typeof import('./src/utils/s3')['deleteS3File']>
    readonly documentLetterHeadType: UnwrapRef<typeof import('./src/utils/static.value')['documentLetterHeadType']>
    readonly documentPriorityType: UnwrapRef<typeof import('./src/utils/static.value')['documentPriorityType']>
    readonly documentPublicationNumberTypes: UnwrapRef<typeof import('./src/utils/static.value')['documentPublicationNumberTypes']>
    readonly documentTabs: UnwrapRef<typeof import('./src/utils/static.value')['documentTabs']>
    readonly documentType: UnwrapRef<typeof import('./src/utils/static.value')['documentType']>
    readonly eagerComputed: UnwrapRef<typeof import('@vueuse/core')['eagerComputed']>
    readonly effectScope: UnwrapRef<typeof import('vue')['effectScope']>
    readonly emailValidator: UnwrapRef<typeof import('./src/@core/utils/validators')['emailValidator']>
    readonly extendRef: UnwrapRef<typeof import('@vueuse/core')['extendRef']>
    readonly fileIcon: UnwrapRef<typeof import('./src/utils/icon.mapped')['fileIcon']>
    ...
    readonly formatFileSize: UnwrapRef<typeof import('./src/utils/attachment.manager')['formatFileSize']>
    readonly formatToWeekdayTime: UnwrapRef<typeof import('./src/utils/converter')['formatToWeekdayTime']>
    readonly getActivePinia: UnwrapRef<typeof import('pinia')['getActivePinia']>
    readonly getCurrentInstance: UnwrapRef<typeof import('vue')['getCurrentInstance']>
    readonly getCurrentScope: UnwrapRef<typeof import('vue')['getCurrentScope']>
    readonly getExtension: UnwrapRef<typeof import('./src/utils/icon.mapped')['getExtension']>
    readonly h: UnwrapRef<typeof import('vue')['h']>
    readonly handleFileChange: UnwrapRef<typeof import('./src/utils/attachment.manager')['handleFileChange']>
    readonly handleFileClick: UnwrapRef<typeof import('./src/utils/attachment.manager')['handleFileClick']>
    readonly handleFileDrop: UnwrapRef<typeof import('./src/utils/attachment.manager')['handleFileDrop']>
    readonly handleRemoveFile: UnwrapRef<typeof import('./src/utils/attachment.manager')['handleRemoveFile']>
    ...
    readonly mapBookingNumber: UnwrapRef<typeof import('./src/utils/model.mapper')['mapBookingNumber']>
    readonly mapDocument: UnwrapRef<typeof import('./src/utils/model.mapper')['mapDocument']>
    readonly mapDocumentReference: UnwrapRef<typeof import('./src/utils/model.mapper')['mapDocumentReference']>
    readonly mapGetters: UnwrapRef<typeof import('pinia')['mapGetters']>
    readonly mapGroupedWithFormat: UnwrapRef<typeof import('./src/utils/model.mapper')['mapGroupedWithFormat']>
    readonly mapPosition: UnwrapRef<typeof import('./src/utils/model.mapper')['mapPosition']>
    readonly mapState: UnwrapRef<typeof import('pinia')['mapState']>
    readonly mapStores: UnwrapRef<typeof import('pinia')['mapStores']>
    readonly mapToAttachments: UnwrapRef<typeof import('./src/utils/model.mapper')['mapToAttachments']>
    readonly mapUser: UnwrapRef<typeof import('./src/utils/model.mapper')['mapUser']>
    readonly mapWritableState: UnwrapRef<typeof import('pinia')['mapWritableState']>
    readonly markRaw: UnwrapRef<typeof import('vue')['markRaw']>
    readonly maxLengthValidator: UnwrapRef<typeof import('./src/@core/utils/validators')['maxLengthValidator']>
    ...
    readonly uploadAllFiles: UnwrapRef<typeof import('./src/utils/attachment.manager')['uploadAllFiles']>
    readonly uploadS3File: UnwrapRef<typeof import('./src/utils/s3')['uploadS3File']>
